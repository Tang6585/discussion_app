...
<div class="container">
    ...
    <div id="discussionForm" class="discussion-form">
        <form method="POST">
            ...
            <div col ="6"><button type="submit" class="button">Submit</button></div><div col = "6"><button class="btn btn-success ms-auto" onclick="window.location.href='index2.php'">veiws Discussion</button></div>
        </form>
    </div>
</div>
</body>